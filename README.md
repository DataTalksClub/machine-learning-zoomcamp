...
<p align="center">
  <a href="https://courses.datatalks.club/register/ml-zoomcamp/"><img src="https://user-images.githubusercontent.com/875246/185755203-17945fd1-6b64-46f2-8377-1011dcb1a444.png" height="50" alt="Register for Machine Learning Zoomcamp"></a>
</p>

<p align="center">
  <a href="https://courses.datatalks.club/register/ml-zoomcamp/">Register</a> |
  <a href="https://courses.datatalks.club/ml-zoomcamp-2026/">Course Platform</a> |
  <a href="https://github.com/DataTalksClub/machine-learning-zoomcamp">Course Materials</a> |
  <a href="https://datatalks.club/slack.html">Join Slack</a> |
  <a href="https://app.slack.com/client/T01ATQK62F8/C0288NJ5XSA">Course Slack Channel</a> |
  <a href="https://t.me/mlzoomcamp">Telegram</a> |
  <a href="https://www.youtube.com/playlist?list=PL3MmuxUbc_hIhxl5Ji8t4O6lPAOpHaCLR">YouTube Playlist</a> |
  <a href="https://datatalks.club/faq/machine-learning-zoomcamp.html">FAQ</a>
</p>

<p align="center">
  <a href="https://github.com/DataTalksClub/machine-learning-zoomcamp/pulls"><img src="https://img.shields.io/badge/PRs-welcome-brightgreen.svg?style=for-the-badge" alt="Pull requests welcome"></a>
  <a href="https://datatalks.club/slack.html"><img src="https://img.shields.io/badge/Slack-Join%20Community-4A154B?style=for-the-badge&logo=slack" alt="Join the DataTalks.Club Slack community"></a>
</p>
...
| Resource | Link |
| --- | --- |
| Register | [Sign up for the free 2026 cohort](https://courses.datatalks.club/register/ml-zoomcamp/) |
| Start date | September 14, 2026 |
| Learn | [Course platform](https://courses.datatalks.club/ml-zoomcamp-2026/) &middot; [Materials](https://github.com/DataTalksClub/machine-learning-zoomcamp) &middot; [Videos](https://www.youtube.com/playlist?list=PL3MmuxUbc_hIhxl5Ji8t4O6lPAOpHaCLR) |
| Current cohort | [2026 syllabus and deadlines](cohorts/2026/) |
| Community | [Slack](https://datatalks.club/slack.html) &middot; [Course channel](https://app.slack.com/client/T01ATQK62F8/C0288NJ5XSA) &middot; [Telegram](https://t.me/mlzoomcamp) |
| Help | [Course docs](https://datatalks.club/docs/courses/ml-zoomcamp/) &middot; [Logistics](https://datatalks.club/docs/courses/zoomcamp-logistics/) &middot; [FAQ](https://datatalks.club/faq/machine-learning-zoomcamp.html) |
...
<p align="center">
  <img src="https://github.com/DataTalksClub/datatalksclub.github.io/blob/main/images/posts/2024-04-11-guide-to-free-online-courses-at-datatalks-club/ml_zoomcamp_overview_horizontal_2025.png" alt="Machine Learning Zoomcamp progression from machine learning algorithms with Python, NumPy, pandas, and scikit-learn to deployment with Docker, FastAPI, and Kubernetes" title="Machine Learning Zoomcamp: from algorithms to deployment" width="500">
</p>
...
| Registration | [Sign up here](https://courses.datatalks.club/register/ml-zoomcamp/) | Start from the repository |
...
1. Follow the [course materials](https://github.com/DataTalksClub/machine-learning-zoomcamp).
2. Watch the lectures in the [YouTube playlist](https://www.youtube.com/playlist?list=PL3MmuxUbc_hIhxl5Ji8t4O6lPAOpHaCLR).
3. Ask questions and share your progress in [DataTalks.Club Slack](https://datatalks.club/slack.html).
4. Complete the homework for practice and build an end-to-end project for your portfolio.
...
<p align="center">
  <img src="https://github.com/DataTalksClub/datatalksclub.github.io/blob/main/images/posts/2025-08-11-tab-1-how-to-build-blood-cell-classifier-for-cancer-prediction-case-study-from-ml-zoomcamp/image9.png" alt="Local deployment architecture using Kubernetes with Kind from a Machine Learning Zoomcamp learner project" title="Learner project: local Kubernetes deployment with Kind" width="500">
</p>

<p align="center"><em>A local deployment architecture using Kubernetes with Kind from a learner project</em></p>

Examples include:

- [Blood cell classifier for cancer prediction](https://datatalks.club/blog/how-to-build-blood-cell-classifier-for-cancer-prediction-case-study-from-ml-zoomcamp.html): an end-to-end tool that segments and classifies blood cells from microscope images to help detect signs of acute lymphoblastic leukemia.
- [Waste classifier](https://datatalks.club/blog/how-to-build-waste-classifier-case-study-from-ml-zoomcamp.html): an Xception-based image classifier trained on approximately 15,000 waste images, achieving 93.3% test accuracy and serving predictions through a Docker-packaged API.

## Certificate

<p align="center">
  <img src="https://github.com/DataTalksClub/datatalksclub.github.io/blob/main/images/posts/2023-08-17-machine-learning-zoomcamp/ml-zoomcamp-certificate.jpg" alt="Machine Learning Zoomcamp certificate of completion" title="Machine Learning Zoomcamp certificate of completion" width="500">
</p>

<p align="center"><em>Machine Learning Zoomcamp certificate awarded after successful completion</em></p>

Certificates are available to learners who complete the requirements during a live cohort.

To qualify, you must:

1. Submit two projects: either the midterm and one capstone, or both capstones.
2. Submit the projects by the applicable cohort deadlines.
3. Review three other learners' projects and provide feedback through the peer-review process.

See the [certificate guide](https://datatalks.club/docs/courses/zoomcamp-logistics/certification/) for details about the process and instructions for adding the certificate to LinkedIn.
...
Join the [#course-ml-zoomcamp](https://app.slack.com/client/T01ATQK62F8/C0288NJ5XSA) channel in [DataTalks.Club Slack](https://datatalks.club/slack.html) to ask questions, troubleshoot problems, discuss the course, and connect with other learners.

To keep discussions useful and organized:

- Check the [FAQ](https://datatalks.club/faq/machine-learning-zoomcamp.html) before posting.
- Follow the [question guidelines](https://datatalks.club/docs/courses/zoomcamp-logistics/asking-questions/) when asking for help.
...
For more answers, see the complete [Machine Learning Zoomcamp FAQ](https://datatalks.club/faq/machine-learning-zoomcamp.html).
...
<p align="center">
  <a href="https://datatalks.club/">DataTalks.Club</a> is a global online community where people learn, share knowledge, ask questions, discuss careers, and help each other build practical data skills.
</p>
...
Most DataTalks.Club activity takes place in [Slack](https://datatalks.club/slack.html), where community members discuss data, learning, projects, and career questions.

DataTalks.Club organizes online events, community activities, and free courses. Learn more in the [DataTalks.Club documentation](https://datatalks.club/docs/general/).
