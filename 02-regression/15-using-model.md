...
![The real-life scenario: a website form with the car details sends a dictionary to the model](images/15-using-model-05-website-request-diagram-imagegen.jpg)
