...
- Output: `cohorts/2026/01-intro/images/08-linear-algebra-01-vector-operations-cropped.jpg`
...
- Output: `cohorts/2026/01-intro/images/08-linear-algebra-02-dot-product-cropped.jpg`
...
- Output: `cohorts/2026/01-intro/images/08-linear-algebra-03-vector-vector-implementation-cropped.jpg`
...
- Output: `cohorts/2026/01-intro/images/08-linear-algebra-04-matrix-vector-idea-cropped.jpg`
...
- Output: `cohorts/2026/01-intro/images/08-linear-algebra-05-matrix-vector-implementation-cropped.jpg`
...
- Output: `cohorts/2026/01-intro/images/08-linear-algebra-06-matrix-matrix-cropped.jpg`
...
- Output: `cohorts/2026/01-intro/images/08-linear-algebra-07-identity-matrix-cropped.jpg`
...
- Output: `cohorts/2026/01-intro/images/08-linear-algebra-08-inverse-cropped.jpg`
...
- Output: `cohorts/2026/01-intro/images/09-pandas-01-create-dataframe-cropped.jpg`
...
- Output: `cohorts/2026/01-intro/images/09-pandas-02-series-and-columns-cropped.jpg`
...
- Output: `cohorts/2026/01-intro/images/09-pandas-03-iloc-cropped.jpg`
...
- Output: `cohorts/2026/01-intro/images/09-pandas-04-filtering-cropped.jpg`
...
- Output: `cohorts/2026/01-intro/images/09-pandas-05-string-operations-cropped.jpg`
...
- Output: `cohorts/2026/01-intro/images/09-pandas-06-describe-cropped.jpg`
...
- Output: `cohorts/2026/01-intro/images/09-pandas-07-missing-values-cropped.jpg`
...
- Output: `cohorts/2026/01-intro/images/09-pandas-08-groupby-cropped.jpg`
...
### 02 — rule-based spam rules

- Source: `cohorts/2026/01-intro/images/10-summary-02-rule-based-spam-rules.jpg`
- Disposition: deterministic crop followed by built-in imagegen redraw
- Crop: `560x300+15+30`; camera/cursor mask in crop: `490,0` to `559,30` and `495,270` to `559,299`
...
- Output: `cohorts/2026/01-intro/images/10-summary-04-supervised-g-x-y-imagegen-pilot.jpg`
...
- Output: `cohorts/2026/01-intro/images/10-summary-05-crisp-dm-bigger-picture-imagegen-pilot.jpg`
...
- Output: `cohorts/2026/01-intro/images/10-summary-06-model-selection-split-imagegen-pilot.jpg`
