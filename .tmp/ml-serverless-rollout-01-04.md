...
- **Disposition:** `crop/replace` → `images/01-intro-01-clothes-classification-use-case-imagegen.jpg`
...
- **Disposition:** `crop/replace` → `images/01-intro-02-aws-lambda-deployment-imagegen.jpg`
...
- **Disposition:** `crop/replace` → `images/01-intro-03-lambda-uses-tf-lite-imagegen.jpg`
...
- **Disposition:** `crop/replace` → `images/02-aws-lambda-07-serverless-vs-serverful-imagegen.jpg`
...
- **Disposition:** `crop/replace` → `images/02-aws-lambda-01-search-lambda-cropped.jpg`
...
- **Disposition:** `crop/replace` → `images/02-aws-lambda-02-create-function-cropped.jpg`
...
- **Disposition:** `crop/replace` → `images/02-aws-lambda-03-pong-handler-cropped.jpg`
...
- **Disposition:** `crop/replace` → `images/02-aws-lambda-04-test-pong-response-cropped.jpg`
...
- **Disposition:** `crop/replace` → `images/02-aws-lambda-05-pants-response-cropped.jpg`
...
- **Disposition:** `crop/replace` → `images/02-aws-lambda-06-final-handler-code-cropped.jpg`
...
- **Disposition:** `crop/replace` → `images/02-aws-lambda-08-invite-link-function-cropped.jpg`
...
- **Disposition:** `crop/replace` → `images/01-intro-04-module-plan-cropped.jpg`
...
- **Disposition:** `crop/replace` → `images/01-intro-05-module-plan-lambda-gateway-cropped.jpg`
...
- **Disposition:** `crop/replace` → `images/03-tensorflow-lite-01-load-keras-model-cropped.jpg`
...
- **Disposition:** `crop/replace` → `images/03-tensorflow-lite-02-keras-predictions-cropped.jpg`
...
- **Disposition:** `crop/replace` → `images/03-tensorflow-lite-03-convert-to-tflite-cropped.jpg`
...
- **Disposition:** `crop/replace` → `images/03-tensorflow-lite-04-model-sizes-cropped.jpg`
...
- **Disposition:** `crop/replace` → `images/03-tensorflow-lite-05-interpreter-indexes-cropped.jpg`
...
- **Disposition:** `crop/replace` → `images/03-tensorflow-lite-06-keras-preprocess-source-cropped.jpg`
...
- **Disposition:** `crop/replace` → `images/03-tensorflow-lite-07-keras-image-helper-cropped.jpg`
...
- **Disposition:** `crop/replace` → `images/03-tensorflow-lite-08-tflite-runtime-install-cropped.jpg`
...
- **Disposition:** `crop/replace` → `images/04-preparing-code-01-lesson-plan-cropped.jpg`
...
- **Disposition:** `crop/replace` → `images/04-preparing-code-02-nbconvert-cropped.jpg`
...
- **Disposition:** `crop/replace` → `images/04-preparing-code-03-generated-script-cropped.jpg`
...
- **Disposition:** `crop/replace` → `images/04-preparing-code-04-predict-function-cropped.jpg`
...
- **Disposition:** `crop/replace` → `images/04-preparing-code-05-test-in-ipython-cropped.jpg`
...
- **Disposition:** `crop/replace` → `images/04-preparing-code-06-final-script-cropped.jpg`
