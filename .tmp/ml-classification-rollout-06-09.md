...
- `06-mutual-info-04-sorted-importance.jpg` →
  `06-mutual-info-04-sorted-importance-cropped.png`
  - Disposition: deterministic crop; exact sorted feature-importance output retained.
  - Crop: `480x255+25+35`; removes notebook/recording chrome and camera tile.
  - Invariants: ordered feature names and visible mutual-information values checked against the lesson; source output remains authoritative.
