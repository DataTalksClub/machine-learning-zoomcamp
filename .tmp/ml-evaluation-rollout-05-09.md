...
- `07-cross-validation-01-kfold-diagram-pilot.png` — **keep**, score 12/12. This existing imagegen pilot is already a crisp, camera-free bounded K-fold diagram: it shows three folds, each train/validation rotation, and the mean/std AUC summary. It was inspected as the referenced source and requires no further regeneration; the original JPG remains preserved beside it.
