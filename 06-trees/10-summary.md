...
![The four main points of the module: decision trees, best splits, random forest, and gradient boosting](images/10-summary-01-summary-slide-imagegen.jpg)
...
![A decision tree asking questions about records, seniority, and job type](images/10-summary-02-decision-tree-imagegen.jpg)
...
![Several diverse decision trees feed an averaged random forest prediction](images/10-summary-04-random-forest-imagegen.jpg)
...
![Gradient boosting trains models sequentially so each model corrects previous errors](images/10-summary-05-gradient-boosting-imagegen.jpg)

![The XGBoost parameters eta, max_depth, and min_child_weight](images/10-summary-06-xgb-parameters-imagegen.jpg)
