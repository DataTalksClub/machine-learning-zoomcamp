...
![The three XGBoost parameters to tune: eta is the size of the step, max_depth controls the trees, and min_child_weight is a rough analogue of min_samples_leaf in random forest](images/08-xgb-tuning-01-parameters-imagegen.jpg)
...
![Comparing validation AUC for eta of 0.3, 1.0, 0.1, 0.05 and 0.01: eta=0.1 reaches the top and stays stable, while eta=1.0 falls below the zoom window](images/08-xgb-tuning-02-tuning-eta-imagegen.jpg)
...
![Validation AUC for max_depth of 6, 3 and 4: depth 3 keeps climbing and stays on top, while deeper trees degrade](images/08-xgb-tuning-03-max-depth-curves-imagegen.jpg)
...
![Validation AUC for min_child_weight of 1, 10 and 30: the three curves are close to each other](images/08-xgb-tuning-04-min-child-weight-curves-imagegen.jpg)
