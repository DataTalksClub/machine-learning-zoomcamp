...
![The plan: first split off 20% for the test set, then split the remaining 80% into train and validation](images/03-validation-01-train-val-test-split-crisp.jpg)
