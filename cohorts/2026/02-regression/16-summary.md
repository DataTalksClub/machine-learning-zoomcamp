...
![Cleaning the data: lowercasing the column names and the string values with str.replace](images/16-summary-01-data-cleaning-crisp.png)
...
![Linear regression for a single example, implemented as a simple formula with a for loop](images/16-summary-03-linear-regression-loop-crisp.png)

![Extending it to the vector form with the dot product](images/16-summary-04-vector-form-crisp.png)
...
![The normal equation implemented in NumPy: inverting the Gram matrix](images/16-summary-05-normal-equation-crisp.png)

![The baseline model: training with only the five base numerical features](images/16-summary-06-baseline-model-crisp.png)
...
![After adding the age feature: the distribution of predictions (red) matches the actual values (blue)](images/16-summary-07-feature-engineering-crisp.png)
...
![Categorical variables: each category becomes a binary column, one-hot encoding](images/16-summary-08-categorical-variables-crisp.png)
