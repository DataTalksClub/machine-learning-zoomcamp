...
![K-fold cross-validation with three folds: train on two, validate on the remaining one, then average the AUCs](images/07-cross-validation-01-kfold-diagram.jpg)
