...
| `06-random-forest-04-tuning-max-depth-imagegen.png` | `06-random-forest.md` depths `5, 10, 15` loop | `732bdc6d1bd4bd488893b53df58b40084a81f2ce7009f883b4a2435380f33c8a` |
| `06-random-forest-05-tuning-min-samples-leaf-imagegen.png` | `06-random-forest.md` leaf sizes `1, 3, 5, 10, 50` loop | `00cf98cbe36d066bec564713f656b6eabdecd15a4037823708426951cb5d14ca` |
...
| `08-xgb-tuning-02-tuning-eta-imagegen.png` | `08-xgb-tuning.md` eta values `0.3, 1.0, 0.1, 0.05, 0.01` | `76d5073a442e076832bf59352991639b24bd3ac167b86d75a8454ea41d7de702` |
| `08-xgb-tuning-03-max-depth-curves-imagegen.png` | `08-xgb-tuning.md` max depths `6, 3, 4` after removing `10` | `0b0831412394b16c2ed94903551c2b90a00ad80e0e4da4554f3936550b87cc30` |
| `08-xgb-tuning-04-min-child-weight-curves-imagegen.png` | `08-xgb-tuning.md` child weights `1, 10, 30` | `6bbc5b0260f6c26a306e1bca6002094382c132a653a7f4f766d96303b5ec8ae3` |
