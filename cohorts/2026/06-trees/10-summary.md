...
![The four main points of the module: decision trees, best splits, random forest, and gradient boosting](images/10-summary-01-summary-slide-crisp.png)
...
![A decision tree asking questions about records, seniority, and job type](images/10-summary-02-decision-tree-crisp.png)

![An unrestricted tree scores 1.0 on train but only 0.654 on validation](images/10-summary-03-overfitting-auc-crisp.png)
...
![Several diverse decision trees feed an averaged random forest prediction](images/10-summary-04-random-forest-crisp.png)
...
![Gradient boosting trains models sequentially so each model corrects previous errors](images/10-summary-05-gradient-boosting-crisp.png)

![The XGBoost parameters eta, max_depth, and min_child_weight](images/10-summary-06-xgb-parameters-crisp.png)
