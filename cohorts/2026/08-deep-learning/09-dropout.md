...
![Dropout 0.2: validation accuracy peaks slightly above 0.84 and then oscillates around 0.83](images/09-dropout-07-dropout-02-vs-train-imagegen.png)
...
![Dropout 0.0: the training accuracy quickly reaches 100% while validation stays around 0.84](images/09-dropout-08-no-regularization-overfit-imagegen.png)
