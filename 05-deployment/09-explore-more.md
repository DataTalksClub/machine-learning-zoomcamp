...
![A packaged model can be served through different frameworks, environments, and cloud destinations.](images/09-explore-more-01-deployment-choices-imagegen.png)
